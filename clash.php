...
<head>
<body bgcolor=\"black\" style="background-color: #00b4ff">
<meta http-equiv="Content-Language" content="en-us" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>.:| Clash Mailer v1.0 |::.</title>
<style type="text/css">
.style1 {
	font-size: x-small;
}
...
<h1 class="auto-style2">.:| Clash Mailer v1.0 |::.</h1>
                ...
                if ($to){
	                ...
	                if ($x==0 && !empty($tem)) {
	                	if(!@mail($tem,$subject,$message,$header)){
	                		...
	                		print('Your Message was Sent Test. Say thx to Clash .<br />');
	                		$tms+=1;
	                	}
	                }
	                ...
	                $xx = $x+1;
	                $txtspamed = "spammed By Clash Haker";
	                if(!$msent){
	                	$txtspamed = "error";
	                	$ns+=1;
	                	$nse[$ns]=$to;
